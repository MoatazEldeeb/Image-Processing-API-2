...
exports.processImage = exports.editPicture = void 0;
var sharp = require('sharp');
var path = require('path');
var fs = require('fs');
var editPicture = function (req, res, next) {
...
var processImage = function (filename, width, height) {
  return __awaiter(void 0, void 0, void 0, function () {
    var err_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            sharp('./full/'.concat(filename, '.jpg'))
              .resize(width, height)
              .toFile(
                ''
                  .concat(filename, '-')
